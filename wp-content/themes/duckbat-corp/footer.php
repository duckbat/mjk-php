...
<div class="container">
  <div class="row">
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/images/vidra.png" alt="Logo" width="50" height="30" class="d-inline-block align-text-top">
    ...
    <div class="col-lg-3 col-xs-12 links">
      <h4 class="mt-lg-0 mt-sm-3 text-white">Follow us</h4>
        <ul class="m-0 p-0">
          <li><a href="#" class="text-white-50">Lorem ipsum</a></li>
          <li><a href="#" class="text-white-50">Nam mauris velit</a></li>
          <li><a href="#" class="text-white-50">Etiam vitae mauris</a></li>
          <li><a href="#" class="text-white-50">Fusce scelerisque</a></li>
          <li><a href="#" class="text-white-50">Sed faucibus</a></li>
          <li><a href="#" class="text-white-50">Mauris efficitur nulla</a></li>
        </ul>
    </div>
